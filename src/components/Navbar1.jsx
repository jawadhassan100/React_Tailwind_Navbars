...
const Navbar1 = () => {
  ...
  return (
    <div >
        <div className="flex justify-between items-center px-3 py-3 sm:px-8 lg:py-5 lg:px-16  bg-slate-200">
        ...
        <div 
         className={`md:hidden lg:hidden xl:hidden fixed top-0 right-0 h-full w-[65%]  bg-slate-200 z-20 rounded-bl-[40%]  text-center transform transition-transform duration-300 ease-in-out ${
          ...
          <div className="h-[89vh] md:h-[89.9vh] lg:h-[86.4vh] bg-slate-100">
